...
**Frame is a domain-specific language for defining and implementing state machines, embedded in your native source code.** Frame enables developers to add state machines as a first-class entity to **17 target languages** — Python, TypeScript, JavaScript, Rust, C, C++, Java, C#, Go, PHP, Kotlin, Swift, Ruby, Erlang, Lua, Dart, GDScript — plus Graphviz for state-diagram visualization.
